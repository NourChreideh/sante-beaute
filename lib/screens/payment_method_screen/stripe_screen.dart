...
class _StripeScreenState extends State<StripeScreen> {
  ...
  void getData() {
    ...
    _webViewController
      ...
      if (decodedJSON == "false") {
        Toast.show("فشل عملية الدفع",
            duration: Toast.lengthLong, gravity: Toast.center);
        Navigator.pop(context);
      } else if (decodedJSON == "true") {
        Toast.show("تم الدفع بنجاح",
            duration: Toast.lengthLong, gravity: Toast.center);
        if (widget.payment_type == "cart_payment") {
        ...
        await AuthRepository().changeorderstatus(_combined_order_id);
      }
    });
  }
  ...
  AppBar buildAppBar(BuildContext context) {
    return AppBar(
      ...
      title: Text(
        AppLocalizations.of(context).stripe_screen_pay_with_moyasar,
