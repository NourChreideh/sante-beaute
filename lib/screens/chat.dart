...
class _ChatState extends State<Chat> {
  ...
  chooseAndUploadImage(context) async {
    ...
    if (status.isGranted) {
      ...
      if (_file == null) {
        ToastComponent.showDialog("file is null",
      ...
      if (imageUploadResponse.result == false) {
        ...
        setState(() {});
        if (_chatTextController.text.trim().isEmpty && _imageUrls.isNotEmpty) {
          onTapSendMessage();
        }
      }
    }
  ...
  onTapSendMessage() async {
    ...
    //print(chatText);
    if (chatText != "" || _imageUrls.length > 0) {
                ...
                children: [
                  (index == _list.length - 1) ||
                      ...
                      ? UsefulElements().customContainer(
                          ...
                          height: 20,
                          borderRadius: 5,
                          bgColor: Color(0xFFF9FAFC),
                          child: Text(
                            "" + _list[index].date.toString(),
                            style: const TextStyle(
                                fontSize: 10, color: Color(0xFFAFB6BE)),
                          ),
                        )
                      : Container(),
                  const SizedBox(
  ...
  Container smsContainer(int index) {
    return Container(
      ...
      padding: const EdgeInsets.only(top: 8, bottom: 0, right: 10, left: 10),
      decoration: BoxDecoration(
        boxShadow: [
          BoxShadow(
      ...
      child: _list[index].message.toString().contains("https://")
          ? Stack(
              children: [
                Positioned(
                    bottom: 2,
              ...
              child: Container(
                ...
                child: TextField(
                  ...
                  decoration: InputDecoration(
                      suffixIcon: GestureDetector(
                        ...
                        child: Padding(
                          padding: const EdgeInsetsDirectional.only(
                              top: 15, bottom: 15, start: 0, end: 0),
                      ...
                      hintStyle: TextStyle(color: Color(0xFFAFB6BE)),
