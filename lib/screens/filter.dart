...
import 'package:mlay_dmp_teams/ui_elements/shop_square_card.dart';
import 'package:mlay_dmp_teams/ui_elements/brand_square_card.dart';
...
import 'package:mlay_dmp_teams/repositories/brand_repository.dart';
import 'package:mlay_dmp_teams/repositories/shop_repository.dart';
import 'package:mlay_dmp_teams/helpers/reg_ex_inpur_formatter.dart';
...
import 'package:mlay_dmp_teams/repositories/search_repository.dart';
            ...
            GestureDetector(
              ...
              child: Container(
                ...
                child: Padding(
                  ...
                  child: SvgPicture.asset("assets/Bag (1).svg"),
                  /* Badge(
                    toAnimate: false,
                  ...
                  decoration: InputDecoration(
                      suffixIcon: GestureDetector(
                        ...
                        child: Container(
                          ...
                          child: Padding(
                            padding: const EdgeInsets.all(8.0),
                            child: Image.asset("assets/Search_w.png"),
                          ),
                        ),
                      ),
                      ...
                      enabledBorder: OutlineInputBorder(
                        borderRadius: BorderRadius.circular(10),
                        borderSide:
                            BorderSide(color: Color(0xFFD4D8DD), width: 0.5),
                      ),
      ...
      return RefreshIndicator(
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            children: [
              SizedBox(
                  height: MediaQuery.of(context).viewPadding.top > 40 ? 80 : 80
