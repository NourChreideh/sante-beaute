...
import 'package:mlay_dmp_teams/custom/fade_network_image.dart';
import 'package:mlay_dmp_teams/custom/lang_text.dart';
import 'package:mlay_dmp_teams/custom/scroll_to_hide_widget.dart';
import 'package:mlay_dmp_teams/custom/useful_elements.dart';
...
import 'package:mlay_dmp_teams/repositories/pickup_points_repository.dart';
import 'package:mlay_dmp_teams/repositories/shipping_repository.dart';
import 'package:mlay_dmp_teams/screens/checkout.dart';
...
import 'package:mlay_dmp_teams/repositories/address_repository.dart';
import 'package:mlay_dmp_teams/helpers/shimmer_helper.dart';
import 'package:mlay_dmp_teams/data_model/city_response.dart';
import 'package:mlay_dmp_teams/data_model/country_response.dart';
...
class _ShippingInfoState extends State<ShippingInfo> {
  ...
  fetchList() async {
    var paymentTypeResponseList = await PaymentRepository()
        .getPaymentResponseList(list: "both", mode: PaymentFor.Order);
...
*/
  ...
  FlatButton buildPickUpPointOption(BuildContext context, sellerIndex) {
    return FlatButton(
  ...
  FlatButton buildAddressOption(BuildContext context, sellerIndex) {
    return FlatButton(
      color: _sellerWiseShippingOption[sellerIndex].shippingOption ==
              ShippingOption.HomeDelivery
          ? MyTheme.accent_color
  ...
  FlatButton buildCarrierOption(BuildContext context, sellerIndex) {
    return FlatButton(
      color: _sellerWiseShippingOption[sellerIndex].shippingOption ==
              ShippingOption.Carrier
          ? MyTheme.accent_color
