...
// import 'package:mlay_dmp_teams/screens/otp.dart';
...
class _RegistrationState extends State<Registration> {
  ...
  onPressSignUp() async {
    ...
    var name = _firstNameController.text +
        " " +
        _familyNameController.text; //_nameController.text.toString();
        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              padding: const EdgeInsets.all(8.0),
              child: Text(
                AppLocalizations.of(context).text_create,
                style: TextStyle(
                  fontSize: 17,
                    ...
                    validator: (value) {
                      if (value.length == 0) {
                        return AppLocalizations.of(context)
                            .registration_screen_name_warning;
                      }
                      return null;
                    },
            ...
            Row(
              ...
              children: [
                Text(
                  AppLocalizations.of(context).hav_account,
                  style: TextStyle(color: MyTheme.font_grey, fontSize: 12),
                ),
                GestureDetector(
                  onTap: () {
