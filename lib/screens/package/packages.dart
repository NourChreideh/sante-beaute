...
import 'package:mlay_dmp_teams/custom/style.dart';
...
import 'package:mlay_dmp_teams/repositories/customer_package_repository.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(
          LangText(context).local.package_screen_title,
