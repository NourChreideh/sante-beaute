...
class MyTheme {
  ...
  static Color accent_color = Color(0xFF1977D7);
  static Color secondary_color = Color(0xFF042167);
  static Color light_color = Color(0xFFD0EFFD);
  static Color text_color = Color(0xFF0C449A);
  // Color.fromRGBO(230,46,4, 1);
  static Color grey_color = Color(0xFF737A82);
  static Color accent_color_shadow = Color(0xFFD0EFFD);
