...
import 'package:mlay_dmp_teams/data_model/cart_count_response.dart';
...
import 'dart:convert';
import 'package:mlay_dmp_teams/data_model/cart_response.dart';
import 'package:mlay_dmp_teams/data_model/cart_delete_response.dart';
import 'package:mlay_dmp_teams/data_model/cart_process_response.dart';
import 'package:mlay_dmp_teams/data_model/cart_add_response.dart';
import 'package:mlay_dmp_teams/data_model/cart_summary_response.dart';
...
class CartRepository {
  ...
  Future<dynamic> getCartCount() async {
    if (is_logged_in.$) {
      ...
      return CartCountResponse(count: 0, status: 0);
    }
  }
