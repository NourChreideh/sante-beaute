...
import 'package:mlay_dmp_teams/data_model/review_response.dart';
import 'package:mlay_dmp_teams/data_model/review_submit_response.dart';

import 'package:mlay_dmp_teams/helpers/shared_value_helper.dart';
import 'package:flutter/foundation.dart';

class ReviewRepository {
  Future<dynamic> getReviewResponse(@required int product_id,
      {page = 1}) async {
    Uri url = Uri.parse(
